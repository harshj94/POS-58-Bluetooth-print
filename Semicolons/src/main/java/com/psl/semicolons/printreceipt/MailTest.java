...
public class MailTest {
	...
	public static void main(String[] args) throws Exception {
		...
		Items i1 = new Items();
		i1.setItem_name("BBQ Pizza");
		i1.setQuantity("2");
		i1.setTotal_p("400");
		i1.setUnit_price("200");

		Items i2 = new Items();
		i2.setItem_name("Panneer Pizza");
		i2.setQuantity("3");
		i2.setTotal_p("300");
		i2.setUnit_price("100");
		Items i[] = new Items[2];
		i[0] = i1;
		i[1] = i2;
	...
	public void sendMail(String attachmentName, Order order) throws MessagingException {
		...
		String from = "harsh_jain@persistent.co.in";
		String pass = "February@2017";
